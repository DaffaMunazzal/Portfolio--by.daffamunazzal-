...
export default {
  ...
  about: {
    ...
    bio: {
      ...
      value: "Programming is not just a technology, but a part of the lifestyle",
  ...
  experience: {
    ...
    items: {
      ...
      2: {
        ...
        location: "Pekalongan, Central Java",
        description: "Computer and Network Engineering major. LKS Graphic Design Participant 2024–2025, Graphic Design Enthusiast.",
        tags: ["Computer & Network Engineering", "Graphic Design"],
      },
      3: {
        title: "Secretary of Computer Development Club",
        institution: "Widya Pratama Institute",
        location: "Pekalongan, Central Java",
        description: "Managed administration and documentation for the Computer Development Club, and assisted in organizing activities and programs.",
        tags: ["Administration", "Documentation", "Club"],
      },
      4: {
        title: "Graphic Designer Intern",
        institution: "MZ Digital Print",
        location: "Pekalongan, Central Java",
        description: "Created and designed various DTF print media, including t-shirts, brochures, invitations, and various promotional materials.",
        tags: ["Canva", "Figma", "Photoshop", "CorelDraw", "DTF Printing"],
      },
      5: {
        title: "1st Place — National Digital Poster Design",
        institution: "Festival Penghela HW UNIMUS 2024",
        location: "Semarang",
        description: "National-level digital poster design competition organized by Universitas Muhammadiyah Semarang.",
        tags: ["Poster Design", "National", "UNIMUS"],
      },
      6: {
        title: "Orion Computer Intern",
        institution: "Orion Computer",
        location: "Pekalongan, Central Java",
        description: "Responsible for computer and printer maintenance, as well as providing technical assistance to customers.",
        tags: ["Computer Maintenance", "Printer Maintenance", "Customer Service"],
      },
      7: {
        title: "Dicoding — AI for Productivity",
        institution: "Dicoding Indonesia",
        location: "Online",
        description: "Completed an AI course covering AI best practices and how to use AI for productivity.",
        tags: ["AI", "Dicoding"],
      },
    },
  },
