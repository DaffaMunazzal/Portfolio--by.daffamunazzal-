...
export default {
  ...
  about: {
    ...
    bio: {
      ...
      value: "Programming bukan hanya sebuah teknologi, tapi bagian dari lifestyle",
  ...
  experience: {
    ...
    items: {
      ...
      3: {
        title: "Sekretaris UKM Pengembangan Komputer",
        institution: "Institut Widya Pratama",
        location: "Pekalongan, Jawa Tengah",
        description: "Mengelola administrasi dan dokumentasi UKM Pengembangan Komputer, serta membantu dalam penyelenggaraan kegiatan dan program kerja UKM.",
        tags: ["Administrasi", "Dokumentasi", "UKM"],

      },
      4: {
        title: "Desainer Grafis Intern",
        institution: "MZ Digital Print",
        location: "Pekalongan, Jawa Tengah",
        description: "Membuat dan mendesain berbagai media cetak DTF, termasuk kaos, brosur, undangan, dan berbagai materi promosi.",
        tags: ["Canva", "Figma", "Photoshop", "CorelDraw", "DTF Printing"],
      },
      5: {
        title: "Juara 1 — Desain Poster Digital Nasional",
        institution: "Festival Penghela HW UNIMUS 2024",
        location: "Semarang",
        description: "Lomba desain poster digital tingkat nasional yang diselenggarakan oleh Universitas Muhammadiyah Semarang",
        tags: ["Desain Poster", "Nasional", "UNIMUS"],
      },
      6: {
        title: "Orion Computer Intern",
        institution: "Orion Computer",
        location: "Pekalongan, Jawa Tengah",
        description: " Bertanggung jawab atas pemeliharaan komputer dan printer, serta memberikan bantuan teknis kepada pelanggan",
        tags: ["Computer Maintenance", "Printer Maintenance", "Customer Service"],
      },
      7: {
        title: "Dicoding — AI untuk Produktivitas",
        institution: "Dicoding Indonesia",
        location: "Online",
        description: "Menyelesaikan kelas AI yang mencakup AI best practices dan cara menggunakan AI untuk produktivitas.",
        tags: ["AI", "Dicoding"],
      },
    },
  },
